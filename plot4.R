...
## TOPLEFT -- Generate plot2: total of actual power used
...
## BOTTOMLEFT -- generate plot: Which parts of the house use power and when
...
with(powData, plot(Date_time, Global_reactive_power,
                   type="n", 
                   xlab="datetime",
                   ylab="Global Reactive Power",
                   ylim=c(0.0,0.5))) # set min/max for y axis
